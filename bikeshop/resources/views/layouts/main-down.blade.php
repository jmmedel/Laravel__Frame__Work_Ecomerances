    ...
    <body>
        ...
        <!-- ==================   End Form search =========================================================  -->
                   @guest
                    ...
                    <!-- ======================  site.logo  ============  -->
                    <img src="{{ Voyager::image(setting('site.logo')) }}" width="120"></a></div>
                </div>
            </nav>
        <!--   ==============  ./ Header Section ==============  -->
